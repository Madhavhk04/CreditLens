...
├── data_warehouse/
│   ├── ddl/
│   │   └── create_schema.sql         # 🛠️ PostgreSQL DDL script
│   └── raw_csvs/
│       └── .gitkeep                  # 📂 Landing directory for raw mock CSVs
├── scripts/
│   ├── data_generator.py             # ⚙️ Python synthetic data script
...
│   ├── module4_risk.sql              # 🛡️ Risk segmentation queries
...
*   **Dimensions:**
    ...
    *   `dim_location` 🗺️: Geographic dimensions (city, state, region).
...
### Step 3: Run the Synthetic Data Generator ⚙️
